...
<a class="navbar-brand js-scroll-trigger" href="#page-top" 
   style="display:block; font-size:20px; font-weight:600; color:#fff; padding-left:80%; background-color:#ffc107; margin-right: 0;">
				Top</a>
	<br/>
	<br/>	
	<div class="container" >
		<div class="row">
			<div class="col-md-4" style="font-size:15px; color:; text-align: center;">
