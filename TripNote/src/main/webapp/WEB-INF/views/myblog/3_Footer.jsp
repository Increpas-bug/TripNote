...
<body>
	...
	<footer>
		<a class="navbar-brand js-scroll-trigger" href="#page-top"
			style="display: block; font-size: 18px; font-weight: 600; color: #ffc107; background-color: #fff; padding-right: 13%; padding-left: 85%; padding-top:0.5%;">
			Top</a>
		
		<div class="container" style="font-size: 15px; color: #fff; text-align: center; padding-top: 4%;">
			<div class="col-md-4">
