...
CREATE TABLE users (
	...
	user_blogyn CHAR(1) DEFAULT 'N' /* 블로그보유여부(있으면:Y, 없으면: N) */
);
...
COMMENT ON COLUMN users.user_blogyn IS '블로그보유여부(있으면:Y, 없으면: N)';
...
CREATE TABLE keeping (
	user_no NUMBER NOT NULL, /* 회원번호 */
	posting_no NUMBER NOT NULL, /* 게시글번호 */
	keeping_date DATE DEFAULT sysdate /* 보관날짜 */
);
...
COMMENT ON COLUMN keeping.keeping_date IS '보관날짜';
...
CREATE TABLE comments (
	...
	comment_date DATE DEFAULT sysdate, /* 댓글날짜 */
...
COMMENT ON COLUMN comments.comment_date IS '댓글날짜';
...
/* 주간좋아요수 */
CREATE TABLE weeklyhitcount (
	posting_no NUMBER, /* 게시글번호 */
	weekly_hitcount NUMBER DEFAULT 0, /* 게시글주간좋아요수 */
	weekly_number VARCHAR2(7) /* 몇주차 */
);

COMMENT ON TABLE weeklyhitcount IS '주간좋아요수';

COMMENT ON COLUMN weeklyhitcount.posting_no IS '게시글번호';

COMMENT ON COLUMN weeklyhitcount.weekly_hitcount IS '게시글주간좋아요수';

COMMENT ON COLUMN weeklyhitcount.weekly_number IS '몇주차';

/* 좋아요 */
CREATE TABLE likes (
	user_no NUMBER NOT NULL, /* 회원번호 */
	posting_no NUMBER NOT NULL, /* 게시글번호 */
	likes_date DATE DEFAULT sysdate /* 좋아요날짜 */
);
...
COMMENT ON COLUMN likes.posting_no IS '게시글번호';

COMMENT ON COLUMN likes.likes_date IS '좋아요날짜';
